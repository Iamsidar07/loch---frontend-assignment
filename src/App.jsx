  ...
  return (
    <div className='relative min-h-screen w-full flex flex-col md:grid grid-cols-10 max-w-[1440px] mx-auto'>
      <div className='w-full h-full md:col-span-6 bg-gradient-to-bl z-10 from-[#16151E] to-black flex flex-col space-y-[16px] p-12 relative'>
        <img src="/blue.svg" alt="" className='absolute w-full h-full object-cover top-0 left-0 bottom-0 -z-10' />
        ...
        <div className='flex flex-col md:flex-row md:justify-between w-full'>
          <div className='w-[335px] h-[306px] relative'>
            <img src="/cohorts-1@2x.png" alt="" className=' w-full h-full object-cover' />
          </div>
          <div className='flex flex-col gap-y-[16px] w-full max-w-[313px] md:items-end '>
            <img src="/eye.svg" alt="" className='w-[32px] h-[32px]' />
            <h2 className='font-medium md:text-right text-[31px] text-[#F2F2F2] stroke-[#000000] leading-9'>Watch what the whales are doing</h2>
            <p className='text-[#F2F2F2] md:text-right font-medium text-[16px]'>All whales are not equal. Know exactly what the whales impacting YOUR portfolio are doing.</p>
          </div>
        </div>
        ...
        <div className='flex'>
          ...
          <div className="flex-1 mt-6 pb-[20px] flex overflow-x-auto hide-scrollbar items-center gap-5 -m-[40px] md:my-0 md:ml-0 md:-mr-[40px]">
        ...
        <img src="/vector.svg" alt="" className='w-[60px] h-[60px] hidden md:block absolute z-10 bottom-[60px] left-[60px]' />
      </div>
